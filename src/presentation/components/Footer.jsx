import { IconInstragram } from '@/presentation/assets/icons/icon-instragram';
import { IconWhatsapp } from '@/presentation/assets/icons/icon-whatsapp';
import { IconApple } from '@/presentation/assets/icons/icon-apple';
import { IconFacebook } from '@/presentation/assets/icons/icon-facebook';
import { IconPlayStore } from '@/presentation/assets/icons/icon-play-store';

import QrAplication from '@/presentation/assets/img/qr-aplication.png';
